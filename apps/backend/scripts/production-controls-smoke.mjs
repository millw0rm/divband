...
const first = await request('POST', '/auth/register', { email: 'owner@example.test', name: 'Owner', password: 'correct horse', inviteCode: 'alpha-invite' });
...
assert.equal(projectBody.project.platformHostname, 'smoke-app.divband.ir');
